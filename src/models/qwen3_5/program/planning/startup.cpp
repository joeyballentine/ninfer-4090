...
void validate_target_options(const execution::Parameters& parameters, DeviceContext& device,
    ...
    // The rotated packed modes (rk8v4, rk4v4, rk4v4-e8) exist only in the sm_89 i8 attention
    // kernels; on any other architecture startup fails before any device memory is reserved.
    if ((options.kv_cache == KvCacheStorage::RotatedInt4KeyInt4ValueGroup64 ||
        ...
        throw std::invalid_argument(
            "kv-dtype rk8v4/rk4v4/rk4v4-e8 requires compute capability 8.9 (RTX 4090 build)");
    }
