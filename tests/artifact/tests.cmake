...
# The CUDA fault injection intercepts the runtime with the GNU linker's --wrap, which link.exe
# has no equivalent for. MSVC builds drop that source and its checks; the file-roundtrip modes
# the writer interop test drives do not need the interception and still run.
if(MSVC)
  ninfer_add_test(ninfer_artifact_materialization_test
    SOURCES "${CMAKE_CURRENT_LIST_DIR}/test_materialization.cpp"
    LIBRARIES ninfer_artifact)
  target_compile_definitions(ninfer_artifact_materialization_test PRIVATE NINFER_NO_LINK_WRAP)
else()
  ninfer_add_test(ninfer_artifact_materialization_test
